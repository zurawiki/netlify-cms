...
/***/ function(module, exports) {
	...
	var indexDocsSubsections = function indexDocsSubsections() {
	  if ($('.docs.page').length) {
	...
	var docsMobileMenu = function docsMobileMenu() {
	  if ($('.docs.page').length) {
	...
	// eventbrite info
	var eventInfoLoad = function eventInfoLoad() {
	  if ($('.community.page').length) {
	    var updateDate = function updateDate(eventDate) {
