...
export default class EntryListing extends React.Component {
  static propTypes = {
    ...
    collections: PropTypes.oneOfType([ImmutablePropTypes.map, ImmutablePropTypes.iterable]).isRequired,
